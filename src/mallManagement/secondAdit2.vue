            ...
            <div style="padding-left: 30px">
                ...
                <div v-show="isShow0">
                    <el-form ref="Aform0" :model="Aform0" label-width="70px">
                        ...
                        <el-form-item label="目标Id">
                            <el-input v-model="Aform0.aims" class="aims"></el-input><span class="redP">(注意 : 请不要输入空格)</span>
                        </el-form-item>
                    </el-form>
                ...
                <div v-show="isShow1">
                    <el-form ref="Aform1" :model="Aform1" label-width="70px">
                        ...
                        <el-form-item label="目标Id">
                            <el-input v-model="Aform1.aims" class="aims"></el-input><span class="redP">(注意 : 请不要输入空格)</span>
                        </el-form-item>
                    </el-form>
                    <span class="fengefu">**********************************************************************</span>
                </div>
                <div v-show="isShow2">
                    <el-form ref="Aform2" :model="Aform2" label-width="70px">
                        ...
                        <el-form-item label="目标Id">
                            <el-input v-model="Aform2.aims" class="aims"></el-input><span class="redP">(注意 : 请不要输入空格)</span>
                        </el-form-item>
                    </el-form>
                    <span class="fengefu">**********************************************************************</span>
                </div>
                <div v-show="isShow3">
                    <el-form ref="Aform3" :model="Aform3" label-width="70px">
                        ...
                        <el-form-item label="目标Id">
                            <el-input v-model="Aform3.aims" class="aims"></el-input><span class="redP">(注意 : 请不要输入空格)</span>
                        </el-form-item>
                    </el-form>
                    <span class="fengefu">**********************************************************************</span>
                </div>
                <div v-show="isShow4">
                    <el-form ref="Aform4" :model="Aform4" label-width="70px">
                        ...
                        <el-form-item label="目标Id">
                            <el-input v-model="Aform4.aims" class="aims"></el-input><span class="redP">(注意 : 请不要输入空格)</span>
                        </el-form-item>
                    </el-form>
                    <span class="fengefu">**********************************************************************</span>
                </div>
...
//            ajax
            ajax() {
                this.$http.post(this.url + '/indexColumn/get_column_info', {templetType: this.templetId00,columnId:this.columnId}, {emulateJSON: true}).then(function (res) {
                    console.log(res);
