        ...
        <div>
            ...
            <el-form ref="Aform4" :model="Aform4" label-width="100px">
                ...
                <el-form-item label="目标Id">
                    ...
                    <el-button @click="clear5">清空</el-button>
                    <span class="redP">(注意 : 请不要输入空格)</span>
                </el-form-item>
...
//清空
            clear1() {
                this.$set(this.arr,0,'http://qqskimage.oss-cn-hangzhou.aliyuncs.com/brand/1516271241514.png');
                this.Aform0.types = '';
                this.Aform0.aims = '';
            },
            clear2() {
                this.$set(this.arr,1,'http://qqskimage.oss-cn-hangzhou.aliyuncs.com/brand/1516271241514.png');
                this.Aform1.types = '';
                this.Aform1.aims = '';
            },
            clear3() {
                this.$set(this.arr,2,'http://qqskimage.oss-cn-hangzhou.aliyuncs.com/brand/1516271241514.png');
                this.Aform2.types = '';
                this.Aform2.aims = '';
            },
            clear4() {
                this.$set(this.arr,3,'http://qqskimage.oss-cn-hangzhou.aliyuncs.com/brand/1516271241514.png');
                this.Aform3.types = '';
                this.Aform3.aims = '';
            },
            clear5() {
                this.$set(this.arr,4,'http://qqskimage.oss-cn-hangzhou.aliyuncs.com/brand/1516271241514.png');
                this.Aform4.types = '';
                this.Aform4.aims = '';
            },
            sure(){
...
//                let i=this.AmarqueeArr.length-1;i>=0;i--
                for(let j=arr.length-1;j>=0;j--){
                    console.log(arr[j]);
                    if(arr[j].imageUrl=='http://qqskimage.oss-cn-hangzhou.aliyuncs.com/brand/1516271241514.png'){
                        arr.splice(j,1);
                    }
                }
                console.log(arr);
                ...
                //保存轮播图
                this.$http.post(this.url+'/topicpoll/add_topicpoll',{data:JSON.stringify(arr)},{emulateJSON:true}).then(function (res) {
                    console.log(res);
            ...
            ajax(){
                //查询轮播图
                this.$http.post(this.url+'/topicpoll/look',{},{emulateJSON:true}).then(function (res) {
                    console.log(res);
                    if(res.data.status==200){
                        if(res.data.data==null){

                        }else{
                            let arr = res.data.data.some;
                            for(let i=0;i<5;i++) {
                                if (arr[i]!=undefined) {
